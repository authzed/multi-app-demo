...
function GroupDetailPage({ currentUser }) {
  ...
  const fetchGroupDetails = useCallback(async () => {
    try {
      const response = await apiRequest(`${API_URLS.groups}/groups`, {
        headers: {
  ...
  const fetchGroupMembers = useCallback(async () => {
    try {
      const response = await apiRequest(`${API_URLS.groups}/groups/${username}/members`, {
        headers: {
          'X-Username': currentUser.username
        }
      })
  ...
  const fetchUsers = useCallback(async () => {
    try {
      const response = await apiRequest(`${API_URLS.groups}/api/users`)
